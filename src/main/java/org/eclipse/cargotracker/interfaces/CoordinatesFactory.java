...
public class CoordinatesFactory {
  ...
  public static Coordinates find(String unLocode) {
    ...
    if (MELBOURNE.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(-38, 145);
    }
    if (STOCKHOLM.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(59, 18);
    }
    if (HELSINKI.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(60, 25);
    }
    if (CHICAGO.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(42, -88);
    }
    if (TOKYO.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(36, 140);
    }
    if (HAMBURG.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(54, 10);
    }
    if (SHANGHAI.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(31, 121);
    }
    if (ROTTERDAM.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(52, 5);
    }
    if (GOTHENBURG.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(58, 12);
    }
    if (HANGZOU.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(30, 120);
    }
    if (NEWYORK.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(41, -74);
    }
    if (DALLAS.getUnLocode().getIdString().equals(unLocode)) {
      return new Coordinates(33, -97);
    }
    if (UNKNOWN.getUnLocode().getIdString().equals(unLocode)) {
