...
public class SampleDataGenerator {
  ...
  private void loadSampleCargos() {
        ...
        new Itinerary(
            Arrays.asList(
                new Leg(
                    ...
                    utcNow().minusDays(7).minusHours(2).minusMinutes(4),
                    utcNow().minusDays(1).minusHours(10).minusMinutes(52)),
                new Leg(
                    SampleVoyages.NEW_YORK_TO_DALLAS,
                    SampleLocations.NEWYORK,
                    SampleLocations.DALLAS,
                    utcNow().plusDays(2).minusHours(18).minusMinutes(38),
                    utcNow().plusDays(6).minusHours(3).minusMinutes(22)),
                new Leg(
                    SampleVoyages.DALLAS_TO_HELSINKI,
                    SampleLocations.DALLAS,
                    SampleLocations.HELSINKI,
                    utcNow().plusDays(8).minusHours(8).minusMinutes(18),
                    utcNow().plusDays(14).minusHours(12).minusMinutes(29))));
    ...
    try {
      HandlingEvent event1 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(5).minusMinutes(5),
              utcNow().minusDays(10).minusHours(9).minusMinutes(11),
              trackingId1,
              null,
      ...
      HandlingEvent event2 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(6).minusMinutes(46),
              utcNow().minusDays(7).minusHours(2).minusMinutes(50),
              trackingId1,
      ...
      HandlingEvent event3 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(15).minusMinutes(26),
              utcNow().minusDays(1).minusHours(4).minusMinutes(32),
              trackingId1,
              SampleVoyages.HONGKONG_TO_NEW_YORK.getVoyageNumber(),
        ...
        new Itinerary(
            Arrays.asList(
                new Leg(
                    ...
                    SampleLocations.NEWYORK,
                    utcNow().minusDays(10).minusHours(1).minusMinutes(19),
                    utcNow().minusDays(3).minusHours(7).minusMinutes(2)),
                new Leg(
                    SampleVoyages.NEW_YORK_TO_DALLAS,
                    SampleLocations.NEWYORK,
                    SampleLocations.DALLAS,
                    utcNow().minusDays(2).minusHours(17).minusMinutes(3),
                    utcNow().plusDays(2).minusHours(5).minusMinutes(20)),
                new Leg(
                    SampleVoyages.DALLAS_TO_HELSINKI,
                    SampleLocations.DALLAS,
                    SampleLocations.STOCKHOLM,
                    utcNow().plusDays(6).minusHours(11).minusMinutes(38),
                    utcNow().plusDays(15).minusHours(4).minusMinutes(1))));
    ...
    try {
      HandlingEvent event1 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(2).minusMinutes(44),
              utcNow().minusDays(15).minusHours(14).minusMinutes(33),
              trackingId2,
              null,
      ...
      HandlingEvent event2 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(3).minusMinutes(12),
              utcNow().minusDays(10).minusHours(3).minusMinutes(17),
              trackingId2,
              SampleVoyages.HONGKONG_TO_NEW_YORK.getVoyageNumber(),
              SampleLocations.HANGZOU.getUnLocode(),
              HandlingEvent.Type.LOAD);
      ...
      HandlingEvent event3 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(3).minusMinutes(21),
              utcNow().minusDays(3).minusHours(22).minusMinutes(1),
              trackingId2,
              SampleVoyages.HONGKONG_TO_NEW_YORK.getVoyageNumber(),
              SampleLocations.NEWYORK.getUnLocode(),
              HandlingEvent.Type.UNLOAD);
      ...
      HandlingEvent event4 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(18).minusMinutes(36),
              utcNow().minusDays(2).minusHours(8).minusMinutes(7),
              trackingId2,
              SampleVoyages.HONGKONG_TO_NEW_YORK.getVoyageNumber(),
              SampleLocations.NEWYORK.getUnLocode(),
              HandlingEvent.Type.LOAD);
        ...
        new Itinerary(
            Arrays.asList(
                new Leg(
                    ...
                    SampleLocations.NEWYORK,
                    SampleLocations.DALLAS,
                    utcNow().minusDays(34).minusHours(1).minusMinutes(1),
                    utcNow().minusDays(28).minusHours(10).minusMinutes(1))));
    ...
    try {
      HandlingEvent event1 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(16).minusMinutes(9),
              utcNow().minusDays(37).minusHours(2).minusMinutes(21),
              trackingId4,
              null,
              SampleLocations.NEWYORK.getUnLocode(),
              HandlingEvent.Type.RECEIVE);
      ...
      HandlingEvent event2 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(3).minusMinutes(9),
              utcNow().minusDays(34).minusHours(3).minusMinutes(8),
              trackingId4,
      ...
      HandlingEvent event3 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(14).minusMinutes(10),
              utcNow().minusDays(28).minusHours(7).minusMinutes(7),
              trackingId4,
              SampleVoyages.NEW_YORK_TO_DALLAS.getVoyageNumber(),
      ...
      HandlingEvent event4 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(22).minusMinutes(1),
              utcNow().minusDays(27).minusHours(18).minusMinutes(3),
              trackingId4,
              null,
              SampleLocations.DALLAS.getUnLocode(),
      ...
      HandlingEvent event5 =
          handlingEventFactory.createHandlingEvent(
              utcNow().minusHours(9).minusMinutes(30),
              utcNow().minusDays(26).minusHours(14).minusMinutes(15),
              trackingId4,
              null,
              SampleLocations.DALLAS.getUnLocode(),
